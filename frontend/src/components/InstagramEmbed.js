  ...
  return (
    <div>
      <blockquote
        ...
        data-instgrm-permalink="https://www.instagram.com/texasmensultimate/?utm_source=ig_embed&amp;utm_campaign=loading"
      ...
      >
        <div style={{ padding: '16px' }}>
          <a
            href="https://www.instagram.com/texasmensultimate/?utm_source=ig_embed&amp;utm_campaign=loading"
          ...
          <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            <a href="https://www.instagram.com/texasmensultimate/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank" rel="noopener noreferrer">Texas TUFF</a> (@<a href="https://www.instagram.com/texasmensultimate/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank" rel="noopener noreferrer">texasmensultimate</a>) • Instagram photos and videos
          </p>
        </div>
      </blockquote>
    </div>
